...
void strbuf_add_commented_lines(struct strbuf *out, const char *buf, size_t size, char comment_line_char)
{
 ...
 * character.
 */
void strbuf_stripspace(struct strbuf *sb, int skip_comments, char comment_line_char)
{
	size_t empties = 0;
